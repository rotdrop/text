...
var logger = (0,_nextcloud_logger__WEBPACK_IMPORTED_MODULE_0__.getLoggerBuilder)().setApp('text').detectUser().build();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mimetypesImages": () => (/* binding */ mimetypesImages),
...
/* harmony export */ });
var _window$oc_appswebroo, _window$oc_appswebroo2;
/*
 * @copyright Copyright (c) 2019 Julius Härtl <jus@bitgrid.net>
 *
 * @author Julius Härtl <jus@bitgrid.net>
...
var mimetypesImages = ['image/png', 'image/jpeg', 'image/jpg', 'image/gif', 'image/x-xbitmap', 'image/x-ms-bmp', 'image/bmp', 'image/svg+xml', 'image/webp'];
...
if (!((_window$oc_appswebroo = window.oc_appswebroots) !== null && _window$oc_appswebroo !== void 0 && _window$oc_appswebroo.richdocuments) && !((_window$oc_appswebroo2 = window.oc_appswebroots) !== null && _window$oc_appswebroo2 !== void 0 && _window$oc_appswebroo2.onlyoffice)) {
...
/* harmony import */ var _plugin_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plugin.js */ "./src/store/plugin.js");
var _mutations;
...
var textModule = {
  state: {
    ...
    viewWidth: (0,_plugin_js__WEBPACK_IMPORTED_MODULE_2__.getClientWidth)(),
    headings: Object.freeze([])
  },
  mutations: (_mutations = {}, _defineProperty(_mutations, _mutation_types_js__WEBPACK_IMPORTED_MODULE_1__.SET_VIEW_WIDTH, function (state, value) {
    state.viewWidth = value;
  }), _defineProperty(_mutations, _mutation_types_js__WEBPACK_IMPORTED_MODULE_1__.SET_SHOW_AUTHOR_ANNOTATIONS, function (state, value) {
    state.showAuthorAnnotations = value;
    persistentStorage.setItem('showAuthorAnnotations', '' + value);
  }), _defineProperty(_mutations, _mutation_types_js__WEBPACK_IMPORTED_MODULE_1__.SET_CURRENT_SESSION, function (state, value) {
    state.currentSession = value;
    persistentStorage.setItem('currentSession', value);
  }), _defineProperty(_mutations, _mutation_types_js__WEBPACK_IMPORTED_MODULE_1__.SET_HEADINGS, function (state, value) {
    ...
    var old = state.headings;
    var headings = value.map(function (row, index) {
      var previous = old[index].level;
      return Object.freeze(_objectSpread(_objectSpread({}, row), {}, {
        previous: previous
      }));
    });
  ...
  actions: {
    setShowAuthorAnnotations: function setShowAuthorAnnotations(_ref, value) {
      ...
      commit(_mutation_types_js__WEBPACK_IMPORTED_MODULE_1__.SET_SHOW_AUTHOR_ANNOTATIONS, value);
    },
    setCurrentSession: function setCurrentSession(_ref2, value) {
      var commit = _ref2.commit;
      commit(_mutation_types_js__WEBPACK_IMPORTED_MODULE_1__.SET_CURRENT_SESSION, value);
    },
    setHeadings: function setHeadings(_ref3, value) {
      var commit = _ref3.commit;
      commit(_mutation_types_js__WEBPACK_IMPORTED_MODULE_1__.SET_HEADINGS, value);
    }
  }
};
var store = new vuex__WEBPACK_IMPORTED_MODULE_4__.Store({
  plugins: [_plugin_js__WEBPACK_IMPORTED_MODULE_2__["default"]],
  modules: {
    text: _objectSpread({
      namespaced: true
    }, textModule)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SET_CURRENT_SESSION": () => (/* binding */ SET_CURRENT_SESSION),
/* harmony export */   "SET_HEADINGS": () => (/* binding */ SET_HEADINGS),
/* harmony export */   "SET_SHOW_AUTHOR_ANNOTATIONS": () => (/* binding */ SET_SHOW_AUTHOR_ANNOTATIONS),
/* harmony export */   "SET_VIEW_WIDTH": () => (/* binding */ SET_VIEW_WIDTH)
/* harmony export */ });
var SET_VIEW_WIDTH = 'SET_VIEW_WIDTH';
var SET_SHOW_AUTHOR_ANNOTATIONS = 'SET_SHOW_AUTHOR_ANNOTATIONS';
var SET_CURRENT_SESSION = 'SET_CURRENT_SESSION';
var SET_HEADINGS = 'SET_HEADINGS';
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "getClientWidth": () => (/* binding */ getClientWidth)
/* harmony export */ });
...
var plugin = function plugin(_ref) {
  var commit = _ref.commit;
  var onResize = debounce__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    commit("text/".concat(_mutation_types_js__WEBPACK_IMPORTED_MODULE_1__.SET_VIEW_WIDTH), getClientWidth());
  }, 100);
...
/******/ 			return "" + chunkId + ".js?v=" + {"vendors":"b909892dea441992ea1f","files-modal":"7b9d89c0b424344aa2bf","editor":"3c490c306fc1c6002b43","editor-rich":"3c3bd25fbacd71337811","highlight/1c":"349a82dac3bbce2839a5","highlight/abnf":"9cad0efbdb241424f680","highlight/accesslog":"ae2fc0104b48abb0465e","highlight/actionscript":"d572dc0a202393a885b9","highlight/ada":"01dd9a9cb3ddf61fa1d3","highlight/angelscript":"c264949748ea69a48a6c","highlight/apache":"dfa901c02263042bb43c","highlight/applescript":"3eea45e1b5fc4e915410","highlight/arcade":"12f0ca9debbebf28301b","highlight/arduino":"78d600b3d6434011073c","highlight/armasm":"30cfc90f184e2838aa9e","highlight/asciidoc":"5684b2fbc9e295d134fb","highlight/aspectj":"bf04489515aeeb21713f","highlight/autohotkey":"1b6e1e548eef3e4e6cda","highlight/autoit":"923983726fea0cdd45be","highlight/avrasm":"bbfb32d7afc2b0f18669","highlight/awk":"754dd4afa8d23cc071e5","highlight/axapta":"7e81c7e189faa1991c6a","highlight/bash":"66fbdec37d6798b470ef","highlight/basic":"8e2ca948b0c250b91e4a","highlight/bnf":"5538f3e53dc30072d26c","highlight/brainfuck":"d7e5b521ab064da75ae7","highlight/c":"180574224061073ac8e0","highlight/c-like":"18b6b44c763d6a0b9255","highlight/cal":"232e44bb8b1b0749daa7","highlight/capnproto":"5e55f5ac4e6f0ad9f07c","highlight/ceylon":"2b6731eba0321fc7d0ca","highlight/clean":"ed7bb55ef8d8515c8d84","highlight/clojure":"402b1e072bbaad4d3ab0","highlight/clojure-repl":"9c4528a065fab659d253","highlight/cmake":"1b0dbd139be450ce5ebf","highlight/coffeescript":"29cc2017463f3c4fc148","highlight/coq":"44d66d96fd2f88119db8","highlight/cos":"1f73c9ae94c42a86ee77","highlight/cpp":"f0c1e2c6a6a79876918d","highlight/crmsh":"05b539a06fb5f7392b46","highlight/crystal":"7dc9fda12ff01f804f9b","highlight/csharp":"776aa50b66b830241060","highlight/csp":"f1f94b614fd01b686fb1","highlight/css":"20a654a236367ab06647","highlight/d":"80a98b5b4444458289dd","highlight/dart":"8d60aa392f64cb42236b","highlight/delphi":"191617af45dbe33fe557","highlight/diff":"1ec333643932b02da5b7","highlight/django":"a751690c25ef6f7a0e7a","highlight/dns":"3d34257ad47f8a580804","highlight/dockerfile":"da6f4b673e41e397f18d","highlight/dos":"48b71a3f6398a8a1c718","highlight/dsconfig":"55763868e5b265cc9097","highlight/dts":"c631fee6ab0536d7f44c","highlight/dust":"a1383246b4e57811195d","highlight/ebnf":"4eab63f89d46bbac8fe2","highlight/elixir":"a80ade191809eeb378ea","highlight/elm":"b33b372bc06580e49147","highlight/erb":"502aaef0a9f72a53dcc2","highlight/erlang":"cb78b3fea39ffe3a15fc","highlight/erlang-repl":"8901ac4683826845cca4","highlight/excel":"918e67aa8c009329003e","highlight/fix":"4a39ec8918fd7bb16051","highlight/flix":"c7383d802c2ee26d8c0c","highlight/fortran":"39826bb08c03a97185a2","highlight/fsharp":"7c8307917516e53c7939","highlight/gams":"1d755ae69f5ff552d5df","highlight/gauss":"1fcf0962a38b06218524","highlight/gcode":"f772195f8b36454d8617","highlight/gherkin":"c7fab5d7fa58173c50ab","highlight/glsl":"3a54d40e1786aa3979ab","highlight/gml":"a573bef8ba307e800f57","highlight/go":"b65329c89ba968e348b4","highlight/golo":"f33c5eb395345d3f2c1c","highlight/gradle":"8f8bcf3ec0af766a3778","highlight/groovy":"5f3ab178f1c0e76f0c7a","highlight/haml":"04a00e3c05cc36b24c03","highlight/handlebars":"96e7ccf163c96ac2eb69","highlight/haskell":"1372b96b9a7911cfa926","highlight/haxe":"427d589c5463529718e1","highlight/hsp":"a729ac07d03075f82f50","highlight/htmlbars":"bf44feeac81d21010d87","highlight/http":"710b75481c335245ad73","highlight/hy":"3d7b95b39202747f2b4b","highlight/inform7":"4368f269218e6eeddd9d","highlight/ini":"8680e1cf63d855da586e","highlight/irpf90":"c9b3e0d5c19ffea432a3","highlight/isbl":"9d216869439a78d0cb6e","highlight/java":"bab0b11fc38d58f8d3ac","highlight/javascript":"ec98da31574cb8b98b3e","highlight/jboss-cli":"4c0756addca89aa2a75f","highlight/json":"0136b64638616d1f117f","highlight/julia":"2298bf780debbf44d87e","highlight/julia-repl":"1b24639a70755f0e6e90","highlight/kotlin":"505f1c45fb1f1afa7de2","highlight/lasso":"b39251e46fc011046e29","highlight/latex":"09705fbba976eef7153b","highlight/ldif":"b96e9a94ab6c31fa2e83","highlight/leaf":"b99a51bac58a6c922a6b","highlight/less":"8b290d7b7442ab6152be","highlight/lisp":"0aeca091746b91ccca51","highlight/livecodeserver":"5bee5c11d0bbe820ac28","highlight/livescript":"898097aaa2fe968666c3","highlight/llvm":"913933f8e1eb20575d88","highlight/lsl":"fe6eb51738b976cd2e7f","highlight/lua":"89f0b20f8b8c1b9454af","highlight/makefile":"0ff66ede75fba8f04a9a","highlight/markdown":"2fb429177c1dab38842e","highlight/mathematica":"f42ab66f91b7154ac15f","highlight/matlab":"03d45a9796f8a22fdb85","highlight/maxima":"9fe5b3a1d08b102d12f7","highlight/mel":"49ed860cd85827fab220","highlight/mercury":"e912059be1ecaacc94f1","highlight/mipsasm":"f13036e6cb1957ac3044","highlight/mizar":"ae1a2e882235739e97b4","highlight/mojolicious":"7b2d482752348ff7e3ed","highlight/monkey":"9cd5e378db418b83f32f","highlight/moonscript":"509dbf99536089146bec","highlight/n1ql":"cf85c2e429997a389d90","highlight/nginx":"3e978330ad8ea8bf21db","highlight/nim":"f647551a914619f4f85b","highlight/nix":"43655d09e291733b91bb","highlight/node-repl":"277182acabd0f68c6543","highlight/nsis":"86b0a8bb0fa5e2d076a9","highlight/objectivec":"b457a54837a7d2bf123a","highlight/ocaml":"029923a820ae94426824","highlight/openscad":"5b215aef6970afa97524","highlight/oxygene":"3a2c31259d323025be85","highlight/parser3":"8eb3ee5818c0ac350686","highlight/perl":"c57d1784bb38dc5e21ef","highlight/pf":"7c3b979a06414ea95a36","highlight/pgsql":"12daf54699a7663d7c50","highlight/php":"ffa3e9546e84007cb3b1","highlight/php-template":"959749352515c90f0d31","highlight/plaintext":"3edd09ff632282552e81","highlight/pony":"a87a1b241d6b6663002a","highlight/powershell":"f34f9aee06af0e236a7f","highlight/processing":"a87439782058c94f109f","highlight/profile":"b5d364b9f062e5bac9f2","highlight/prolog":"1ac791c20655fc26de4b","highlight/properties":"97f68b9c8dc62023a7ed","highlight/protobuf":"b9f5ece19ce87d7d64cf","highlight/puppet":"1bf63e6d8ff5d3d038bb","highlight/purebasic":"d0556922dc79a866aff4","highlight/python":"32f73a194f562cdfa04f","highlight/python-repl":"d3b85f1e0dab2386f7f3","highlight/q":"c66f958f6aa8f7fa0e7b","highlight/qml":"7675f17593aca04f7471","highlight/r":"92e69909e58cbe3e6555","highlight/reasonml":"f74d06bcff30644ea23d","highlight/rib":"3bcbc2fed9d45a5a01c9","highlight/roboconf":"b9837d5c7d664067d6e4","highlight/routeros":"aa9802c27ff6f18f94f0","highlight/rsl":"a938c1806315b44feb42","highlight/ruby":"0e39209d11a223c52e43","highlight/ruleslanguage":"980e336df1ae4448d2f1","highlight/rust":"512230da46751e6bd937","highlight/sas":"2e90e55ae8ff8aa609f4","highlight/scala":"ef9bba742b983cce0410","highlight/scheme":"50d591aebfcb672119ac","highlight/scilab":"341a250e6617de75638e","highlight/scss":"0b33d840eb24d4d9c767","highlight/shell":"0fb2dcdaa79e3d51b8d3","highlight/smali":"c28ac807763cd4c9f7b9","highlight/smalltalk":"a9ab2c9c5dc6eb837791","highlight/sml":"2dffec8c21df9e834eb9","highlight/sqf":"e0816f37a670d9d35920","highlight/sql":"d67282e89724e03a0ae9","highlight/sql_more":"10a312d6959649ecf15d","highlight/stan":"6ec9246c55dc79b51656","highlight/stata":"b1106b626d723af78678","highlight/step21":"285024239ff3f315fc77","highlight/stylus":"f9ae5ac8012f3c68c818","highlight/subunit":"d8c230e9f518ac832d16","highlight/swift":"bac497d779bfe68c2461","highlight/taggerscript":"33b58a0e1d7a619b4299","highlight/tap":"00c84dbf18cf7d2c921e","highlight/tcl":"57a4f56eb1ac7f98b201","highlight/thrift":"db746a3478e1dabd03d2","highlight/tp":"d785810316c50fac70a5","highlight/twig":"fbc20bb8d2bdc4586c75","highlight/typescript":"d4e7f391f842e4b43caa","highlight/vala":"b0a509781461e978e5b1","highlight/vbnet":"d43dbc5eade43a81fe29","highlight/vbscript":"4f89892dbbf92371f52d","highlight/vbscript-html":"89925a7a670c25281b97","highlight/verilog":"ae2a3678fcb3d829ec4b","highlight/vhdl":"77bd7df7d2bb8e31b7b9","highlight/vim":"e21a612465e77e322b85","highlight/x86asm":"e4dcdcef4f8d48bc9eca","highlight/xl":"aed707af654876795ec2","highlight/xml":"ee614f17c52eb381d207","highlight/xquery":"4fb70c159eb2bf1a5264","highlight/yaml":"3c73680b29a7cdce3146","highlight/zephir":"f33cf7ba93151a29efdb","editor-collab":"5d3ce776560cd86a3d5e","editor-guest":"54b9406f86ad1109c804"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/initial-state */ "./node_modules/@nextcloud/initial-state/dist/index.esm.js");
/* harmony import */ var _helpers_files_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/files.js */ "./src/helpers/files.js");
/* harmony import */ var _helpers_logger_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/logger.js */ "./src/helpers/logger.js");
/* harmony import */ var _helpers_mime_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/mime.js */ "./src/helpers/mime.js");
...
var loadEditor = function loadEditor(_ref) {
  var sharingToken = _ref.sharingToken,
    mimetype = _ref.mimetype,
    $el = _ref.$el;
  var container = document.createElement('div');
  container.id = 'texteditor';
  document.getElementById('app-content').appendChild(container);
  Promise.all([Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js")), Promise.all(/*! import() | editor */[__webpack_require__.e("vendors"), __webpack_require__.e("editor")]).then(__webpack_require__.bind(__webpack_require__, /*! ./components/Editor.vue */ "./src/components/Editor.vue"))]).then(function (_ref2) {
    ...
    return _helpers_logger_js__WEBPACK_IMPORTED_MODULE_2__.logger.error('Failed to attach editor', {
      error: error
    });
  });
};
(0,_helpers_index_js__WEBPACK_IMPORTED_MODULE_4__.documentReady)(function () {
  ...
  if (filesTable) {
    OC.Plugins.register('OCA.Files.FileList', _helpers_files_js__WEBPACK_IMPORTED_MODULE_1__.FilesWorkspacePlugin);
    (0,_helpers_files_js__WEBPACK_IMPORTED_MODULE_1__.registerFileActionFallback)();
    (0,_helpers_files_js__WEBPACK_IMPORTED_MODULE_1__.registerFileCreate)();
    return;
  }

  // single file share
  if (_helpers_mime_js__WEBPACK_IMPORTED_MODULE_3__.openMimetypes.indexOf(mimetype) !== -1) {
    loadEditor({
      mimetype: mimetype,
...
OCA.Text = {
  RichWorkspaceEnabled: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__.loadState)('text', 'workspace_available')
};
})();

/******/ })()
;
//# sourceMappingURL=text-public.js.map?v=9c08dbc11cf6a4536f11